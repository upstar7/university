...
export const routes = [
  {
    ...
    pages: [
      {
        icon1: <img style={{maxWidth:'20px', height:'20px'}} src={dashboard1} />,
        icon2: <img style={{maxWidth:'20px', height:'20px'}} src={dashboard2} />,
        name: "dashboard",
        path: "/dashboard",
        element: <Home />,
      },
      {
        icon1: <img style={{maxWidth:'20px', height:'20px'}} src={University1}  />,
        icon2: <img style={{maxWidth:'20px', height:'20px'}} src={University2}  />,
        name: "University module",
        path: "/university_module/*",
        element: <Universitymodule />,
      },
      {
        icon1: <img style={{maxWidth:'20px', height:'20px'}} src={Leads1} />,
        icon2: <img style={{maxWidth:'20px', height:'20px'}} src={Leads2} />,
        name: "Leads Modules",
        path: "/Leadsmodule/*",
        element: <Leadsmodule />,
      },
      {
        icon1: <img style={{maxWidth:'20px', height:'20px'}} src={application1} />,
        icon2: <img style={{maxWidth:'20px', height:'20px'}} src={application2} />,
        name: "Application Management",
        path: "/ApplicationModule/*",
        element: <ApplicationModule />,
      },
      {
        icon1: <img style={{maxWidth:'20px', height:'20px'}} src={invoice1} />,
        icon2: <img style={{maxWidth:'20px', height:'20px'}} src={invoice2}  />,
        name: "Invoice Management",
        path: "/InvoiceManagement/*",
        element: <InvoiceManagement />,
      },
      {
        icon1: <img style={{maxWidth:'20px', height:'20px'}} src={Accounting1} />,
        icon2: <img style={{maxWidth:'20px', height:'20px'}} src={Accounting2}  />,
        name: "Accounting System",
        path: "/Accounting/*",
        element: <AccountingSystem />,
      },
      {
        icon1: <img style={{maxWidth:'20px', height:'20px'}} src={report1}  />,
        icon2: <img style={{maxWidth:'20px', height:'20px'}} src={report2}  />,
        name: "report",
        path: "/reportsManagement/*",
        element: <ReportsManagement />,
      },
      {
        icon1: <img style={{maxWidth:'20px', height:'20px'}} src={setting1}  />,
        icon2: <img style={{maxWidth:'20px', height:'20px'}} src={setting2}  />,
        name: "settingsManagement",
        path: "/settingsManagement/*",
        element: <SettingsManagement />,
      },
      {
        icon1: <img style={{maxWidth:'20px', height:'20px'}} src={currency1}  />,
        icon2: <img style={{maxWidth:'20px', height:'20px'}} src={currency2} />,
        name: "currency",
        path: "/CurrencyManagement/*",
        element: <CurrencyManagement />,
      },
      {
        icon1: <img style={{maxWidth:'20px', height:'20px'}} src={system1} />,
        icon2: <img style={{maxWidth:'20px', height:'20px'}} src={system2}  />,
        name: "system",
        path: "/system/*",
        element: <System />,
      }
