        ...
        <div className="mt-[30px] w-full bg-[#E8E9EB]">
            ...
            <div className="bg-white rounded-[34px] p-[39px]">
                ...
                <div className="grid grid-cols-1  laptop:grid-cols-2 gap-[30px]">
                    ...
                    <div >
                        ...
                        <button data-modal-target="defaultModal1" data-modal-toggle="defaultModal" class="w-full block text-[#BEBFC3] justify-center" type="button">
                        Click to add more field
                        </button>
                        <CustomModal myID="defaultModal1"/>
            ...
            <div className="bg-white rounded-[34px] p-[39px]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 laptop:grid-cols-3 gap-[30px]">
                    ...
                    <div >
                        <p className=" text-base font-semibold my-4">Add Field</p>
                        <button data-modal-target="defaultModall" data-modal-toggle="defaultModal" class="w-full block text-[#BEBFC3] justify-center" type="button">
                        Click to add more field
                        </button>
                        <CustomModal myID="defaultModall"/>
                    </div>
                </div>
            </div>
            <div className="bg-white rounded-[34px] p-[39px]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 laptop:grid-cols-3 gap-[30px]">
                    ...
                    <div className="my-10" >
                        ...
                        <button data-modal-target="defaultModal" data-modal-toggle="defaultModal" class="w-full block text-[#BEBFC3] justify-center" type="button">
                        Click to add more field
                        </button>   
                        <CustomModal myID="defaultModal"/>
                    </div>
            </div>
